...
"C:/Users/WilliamLeara/Desktop/UniversalIndentGUI_win32/indenters/uncrustify.exe" -f "%%G" -c "./call_Uncrustify.cfg" -o indentoutput.tmp
...
"C:/Users/WilliamLeara/Desktop/UniversalIndentGUI_win32/indenters/uncrustify.exe" -f "%1" -c "./call_Uncrustify.cfg" -o indentoutput.tmp
